...
public class RfbConnectionTests
{
    ...
    public RfbConnectionTests()
    {
        ...
        _protocolMock.Setup(p => p.CreateRfbInitializer(It.IsAny<RfbConnectionContext>()))
            .Returns(_rfbInitializerMock.Object);
        _protocolMock.Setup(p => p.CreateMessageReceiver(It.IsAny<RfbConnectionContext>()))
            .Returns(_messageReceiverMock.Object);
        _protocolMock.Setup(p => p.CreateMessageSender(It.IsAny<RfbConnectionContext>()))
            .Returns(_messageSenderMock.Object);
        _protocolMock.Setup(p => p.CreateStateObject(It.IsAny<RfbConnectionContext>()))
            .Returns(_protocolStateMock.Object);
    }
    ...
    public async Task Updates_ConnectionState_On_Connect_Reconnect_Close()
    {
        ...
        await Assert.PropertyChangedAsync(rfbConnection, nameof(rfbConnection.ConnectionState), () => {
            ...
            _messageReceiverMock.Raise(receiver => receiver.Failed += null,
                new BackgroundThreadFailedEventArgs(new("Shit happens.")));
