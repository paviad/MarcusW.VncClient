...
public partial class VncView
{
    ...
    public static readonly DirectProperty<VncView, bool> AutoResizeRemoteProperty =
        AvaloniaProperty.RegisterDirect<VncView, bool>(nameof(AutoResizeRemote), o => o.AutoResizeRemote,
            (o, v) => o.AutoResizeRemote = v, true);
    ...
    public static readonly DirectProperty<VncView, global::Avalonia.Size?> OptimalSizeProperty =
        AvaloniaProperty.RegisterDirect<VncView, global::Avalonia.Size?>(nameof(OptimalSize), o => o.OptimalSize,
            (o, v) => o.OptimalSize = v);

    private bool _autoResizeRemote = true;
    private global::Avalonia.Size? _optimalSize;

    private SizeSource _sizeSource = SizeSource.None;
    private IDisposable _sizeSubscription = Disposable.Empty;

    /// <summary>
    ///     Gets or sets whether the remote view should be automatically resized to fit the current <see cref="VncView" />'s
    ///     size (or the <see cref="OptimalSize" />).
    /// </summary>
    ...
    ///     If set to <see langword="null" />, the size of this <see cref="VncView" /> itself is used as the optimal size for
    ///     the remote view.
    /// </summary>
    /// <remarks>
