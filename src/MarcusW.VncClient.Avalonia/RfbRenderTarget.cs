...
/// </summary>
/// <remarks>
///     This control ignores the VNC multi-screen feature and therefore renders all screens (the whole framebuffer) in one
///     piece.
/// </remarks>
[PublicAPI]
public class RfbRenderTarget : Control, IRenderTarget, IDisposable
{
    ...
    {
        ObjectDisposedException.ThrowIf(_disposed, typeof(RfbRenderTarget));
        ...
        if (sizeChanged)
        {
            ...
            bitmap = new(requiredPixelSize, new(96.0f, 96.0f));
