...
public readonly struct Rectangle : IEquatable<Rectangle>
{
    ...
    /// </summary>
    public static readonly Rectangle Zero = new(Position.Origin, Size.Zero);
    ...
    public Rectangle WithPosition(Position position) => new(position, Size);
    ...
    /// <returns>A new rectangle.</returns>
    public Rectangle WithSize(Size size) => new(Position, size);
    ...
    public bool Overlaps(in Rectangle area)
    {
        ...
        bool overlapsX = IsValueInside(Position.X, area.Position.X, area.Position.X + area.Size.Width)
            || IsValueInside(area.Position.X, Position.X, Position.X + Size.Width);
        bool overlapsY = IsValueInside(Position.Y, area.Position.Y, area.Position.Y + area.Size.Height)
            || IsValueInside(area.Position.Y, Position.Y, Position.Y + Size.Height);
