...
{
    private readonly object _continuousUpdatesEnabledLock = new();

    private readonly object _desktopIsResizableLock = new();

    private readonly object _desktopNameLock = new();
    ...
    private readonly object _protocolVersionLock = new();

    private readonly object _remoteFramebufferFormatLock = new();

    private readonly object _remoteFramebufferLayoutLock = new();

    private readonly object _remoteFramebufferSizeLock = new();

    private readonly object _usedEncodingTypesLock = new();

    private readonly object _usedMessageTypesLock = new();

    private readonly object _usedSecurityTypeLock = new();
    private bool _continuousUpdatesEnabled;
    private bool _desktopIsResizable;
    ...
    public bool ContinuousUpdatesEnabled
    {
        ...
        internal set
            => RaiseAndSetIfChangedWithLock(ref _continuousUpdatesEnabled, value, _continuousUpdatesEnabledLock);
    }
}
