...
{
    /// <summary>
    ///     Writes the <paramref name="message" /> (including the message header) to the transport stream.
    /// </summary>
    /// <param name="message">The message to write.</param>
    /// <param name="transport">The target transport.</param>
    /// <param name="cancellationToken">The cancellation token.</param>
    void WriteToTransport(IOutgoingMessage<IOutgoingMessageType> message, ITransport transport,
