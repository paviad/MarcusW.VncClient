...
public class DesktopSizeEncodingType(RfbConnectionContext context) : PseudoEncodingType
{
    private readonly ILogger<DesktopSizeEncodingType> _logger =
        context.Connection.LoggerFactory.CreateLogger<DesktopSizeEncodingType>();
    ...
    public override void ReadPseudoEncoding(Stream transportStream, Rectangle rectangle)
    {
        ...
        context.MessageSender.EnqueueMessage(new FramebufferUpdateRequestMessage(false, wholeScreenRectangle));
    }
}
