...
public class DefaultImplementation : IRfbProtocolImplementation
{
    ...
    ///     Initializes a new instance of the <see cref="DefaultImplementation" />.
    /// </summary>
    /// <param name="securityTypesCollectionBuilder">
    ///     A method that newly creates all the security types that are supported by
    ///     this protocol instance. See <see cref="GetDefaultSecurityTypes" />.
    /// </param>
    /// <param name="messageTypesCollectionBuilder">
    ///     A method that newly creates all the message types that are supported by
    ///     this protocol instance. See <see cref="GetDefaultMessageTypes" />.
    /// </param>
    /// <param name="encodingTypesCollectionBuilder">
    ///     A method that newly creates all the encoding types that are supported by
    ///     this protocol instance. See <see cref="GetDefaultEncodingTypes" />.
    /// </param>
    public DefaultImplementation(SecurityTypesCollectionBuilderDelegate securityTypesCollectionBuilder,
        MessageTypesCollectionBuilderDelegate messageTypesCollectionBuilder,
        EncodingTypesCollectionBuilderDelegate encodingTypesCollectionBuilder)
    {
        ...
        _securityTypesCollectionBuilder = securityTypesCollectionBuilder
            ?? throw new ArgumentNullException(nameof(securityTypesCollectionBuilder));
        _messageTypesCollectionBuilder = messageTypesCollectionBuilder
            ?? throw new ArgumentNullException(nameof(messageTypesCollectionBuilder));
        _encodingTypesCollectionBuilder = encodingTypesCollectionBuilder
            ?? throw new ArgumentNullException(nameof(encodingTypesCollectionBuilder));
    }

    /// <summary>
    ///     Gets whether the Tight encoding type is available. If it's not, consider installing the TurboJPEG library on your
    ///     system.
    /// </summary>
    ...
    /// <inhertitdoc />
    public virtual IImmutableSet<IMessageType> CreateMessageTypesCollection(RfbConnectionContext context)
        => _messageTypesCollectionBuilder.Invoke(context).ToImmutableHashSet();
    ...
    /// <inheritdoc />
    public virtual ITransportConnector CreateTransportConnector(RfbConnectionContext context)
        => new TransportConnector(context);
    ...
    /// <inheritdoc />
    public virtual IRfbMessageReceiver CreateMessageReceiver(RfbConnectionContext context)
