...
public class KeyEventMessageType : IOutgoingMessageType
{
    ...
    {
        if (message is not KeyEventMessage keyEventMessage)
        {
...
public class KeyEventMessage(bool downFlag, KeySymbol keySymbol) : IOutgoingMessage<KeyEventMessageType>
{
    /// <summary>
    ///     Gets whether this is a key down or key up event.
    /// </summary>
    public bool DownFlag { get; } = downFlag;

    /// <summary>
    ///     Gets the key symbol as defined by the X Window System.
    /// </summary>
    public KeySymbol KeySymbol { get; } = keySymbol;
