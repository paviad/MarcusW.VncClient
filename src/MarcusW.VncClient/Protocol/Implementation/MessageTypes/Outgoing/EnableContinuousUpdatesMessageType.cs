...
public class EnableContinuousUpdatesMessageType : IOutgoingMessageType
{
    ...
    {
        if (message is not EnableContinuousUpdatesMessage enableContinuousUpdatesMessage)
        {
...
public class EnableContinuousUpdatesMessage(bool enable, Rectangle rectangle)
    : IOutgoingMessage<EnableContinuousUpdatesMessageType>
{
    /// <summary>
