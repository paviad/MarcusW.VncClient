...
public class FramebufferUpdateRequestMessageType : IOutgoingMessageType
{
    ...
    {
        if (message is not FramebufferUpdateRequestMessage framebufferUpdateRequestMessage)
        {
...
public class FramebufferUpdateRequestMessage(bool incremental, Rectangle rectangle)
    : IOutgoingMessage<FramebufferUpdateRequestMessageType>
{
    /// <summary>
