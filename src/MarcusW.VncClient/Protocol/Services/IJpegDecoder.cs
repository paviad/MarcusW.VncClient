...
/// </summary>
/// <remarks>
///     It's not necessary that implementations of this interface are thread-safe because the processing of received frames
///     always happens synchronously in a single thread.
...
{
    /// <summary>
    ///     Decompresses a JPEG encoded image to a 32bit <paramref name="pixelsBuffer" />.
    /// </summary>
    ...
    /// <param name="usedPixelFormat">
    ///     The pixel format that was chosen for the pixels written to the
    ///     <paramref name="pixelsBuffer" />.
    /// </param>
    /// <param name="cancellationToken">The cancellation token.</param>
    void DecodeJpegTo32Bit(Span<byte> jpegBuffer, Span<byte> pixelsBuffer, int expectedWidth, int expectedHeight,
        PixelFormat preferredPixelFormat, out PixelFormat usedPixelFormat,
