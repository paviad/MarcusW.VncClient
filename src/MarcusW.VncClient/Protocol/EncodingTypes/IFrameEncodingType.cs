...
public interface IFrameEncodingType : IEncodingType
{
    ...
    /// <summary>
    ///     Reads a (partial) frame from the transport stream, decodes it and renders it to the target framebuffer, if
    ///     available.
    /// </summary>
    ...
    void ReadFrameEncoding(Stream transportStream, IFramebufferReference? targetFramebuffer, in Rectangle rectangle,
        in Size remoteFramebufferSize, in PixelFormat remoteFramebufferFormat);
}
