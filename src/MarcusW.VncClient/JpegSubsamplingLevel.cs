...
/// </summary>
[PublicAPI]
public enum JpegSubsamplingLevel
{
    /// <summary>
    ...
    ///     This would typically be implemented using 4:2:0 subsampling (2X subsampling in both X and Y directions), but it
    ///     could also be implemented using 4:1:1
    ...
    ///     This would typically be implemented using 4:1:0 subsampling (4X subsampling in the X direction and 2X subsampling
    ///     in the Y direction.)
    /// </summary>
