...
public abstract class FreezableParametersObject
{
    ...
    /// <summary>
    ///     Validates the parameters of this object and throws a <see cref="ConnectParametersValidationException" /> for the
    ///     first error found.
    /// </summary>
    ...
    /// <summary>
    ///     Validates the parameters of this object and all descendants and throws a
    ///     <see cref="ConnectParametersValidationException" /> for the first error found.
    /// </summary>
    ...
    /// <summary>
    ///     Returns all referenced <see cref="FreezableParametersObject" /> descendants of this object or
    ///     <see langword="null" />, when there aren't any.
    /// </summary>
    ...
    /// <summary>
    ///     Throws a <see cref="InvalidOperationException" /> if this object is frozen, otherwise <paramref name="action" /> is
    ///     executed.
    /// </summary>
