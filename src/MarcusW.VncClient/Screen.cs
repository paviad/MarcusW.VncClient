...
/// <param name="rectangle">The rectangle of the screen on the framebuffer.</param>
/// <param name="flags">The flags.</param>
public readonly struct Screen(uint id, Rectangle rectangle, uint flags) : IEquatable<Screen>
{
    /// <summary>
    ///     Gets the screen id.
    /// </summary>
