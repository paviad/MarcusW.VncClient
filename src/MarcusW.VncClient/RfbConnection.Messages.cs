...
public partial class RfbConnection
{
    ...
    /// </remarks>
    public bool EnqueueMessage<TMessageType>(IOutgoingMessage<TMessageType> message,
    ...
    ///     <see cref="RfbConnection.UsedMessageTypes" />.
    /// </remarks>
    public Task SendMessageAsync<TMessageType>(IOutgoingMessage<TMessageType> message,
        CancellationToken cancellationToken = default) where TMessageType : class, IOutgoingMessageType
    {
        cancellationToken.ThrowIfCancellationRequested();
